About python-graphviz-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-graphviz-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4978&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-graphviz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-graphviz` can be installed with `conda`:
...
It is possible to list all of the versions of `python-graphviz` available on your platform with `conda`:
...
```
mamba search python-graphviz --channel conda-forge
```
...
mamba repoquery search python-graphviz --channel conda-forge

# List packages depending on `python-graphviz`:
mamba repoquery whoneeds python-graphviz --channel conda-forge

# List dependencies of `python-graphviz`:
mamba repoquery depends python-graphviz --channel conda-forge
```
